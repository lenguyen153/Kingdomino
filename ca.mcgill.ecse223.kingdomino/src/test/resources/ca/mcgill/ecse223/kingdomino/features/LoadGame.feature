Feature: Load Game
  ...
  Scenario Outline: Load valid incomplete game
    ...
    Examples:
      ...
      | src/test/resources/kingdomino_test_game_1.json| 4         | 1,5,39,41     | 2,9,15,10   | 3,4,17,6      |  8,42,28        | 34        | 37        | 29        | 44        | 22               |
      | src/test/resources/kingdomino_test_game_2.json| 1         | 1,5,39,41     | 2,9,15,10   | 3,4,17,6      |  8,42,28,44     | 34        | 37        | 29        | 22        | 7, 21, 25, 48    |
    # Variables:
  ...
  Scenario Outline: Invalid placement in game file
    ...
    Examples:
      | filename                                                       |
      | src/test/resources/kingdomino_test_game_invalid_move_1.json    |
      | src/test/resources/kingdomino_test_game_invalid_move_2.json    |
      | src/test/resources/kingdomino_test_game_invalid_move_3.json    |
      | src/test/resources/kingdomino_test_game_invalid_move_4.json    |
